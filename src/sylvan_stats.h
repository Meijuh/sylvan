...
typedef enum {
    ...
    /* TBDD operations */
    OPCOUNTER(TBDD_FROM_MTBDD),
    OPCOUNTER(TBDD_TO_MTBDD),
    OPCOUNTER(TBDD_AND),
    OPCOUNTER(TBDD_AND_DOM),
    OPCOUNTER(TBDD_ITE),
    OPCOUNTER(TBDD_NOT),
    OPCOUNTER(TBDD_EXISTS),
    OPCOUNTER(TBDD_EXTEND_DOMAIN),
    OPCOUNTER(TBDD_UNION_CUBE),
    OPCOUNTER(TBDD_SATCOUNT),
    OPCOUNTER(TBDD_MERGE_DOMAINS),
    OPCOUNTER(TBDD_RELNEXT),
