...
} sylvan_report_info[] =
{
    ...
    {1, TBDD_NODES_CREATED, "TBDD nodes created"},
    {1, TBDD_NODES_REUSED, "TBDD nodes reused"},
    ...
    {2, TBDD_FROM_MTBDD, "TBDD from_mtbdd"},
    {2, TBDD_FROM_MTBDD, "TBDD to_mtbdd"},
    {2, TBDD_AND, "TBDD and"},
    {2, TBDD_AND_DOM, "TBDD and dom"},
    {2, TBDD_ITE, "TBDD ite"},
    {2, TBDD_NOT, "TBDD not"},
    {2, TBDD_EXISTS, "TBDD exists"},
    {2, TBDD_EXTEND_DOMAIN, "TBDD ext_domain"},
    {2, TBDD_SATCOUNT, "TBDD satcount"},
    {2, TBDD_MERGE_DOMAINS, "TBDD merge_dom"},
    {2, TBDD_RELNEXT, "TBDD relnext"},
